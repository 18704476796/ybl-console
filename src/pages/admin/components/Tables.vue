  ...
  <el-table
    ...
    <el-table-column prop="" label="操作">
      <template slot-scope="scope">
        <el-button-group>
          <el-button type="primary" icon="el-icon-edit" @click="edit(scope.row.locked, scope.row.userName, scope.row.realName, scope.row.phoneNum, scope.row.roleName, scope.row.email, scope.row.id)">编辑</el-button>
...
export default {
  ...
  methods: {
    ...
    edit (locked, userName, realName, phoneNum, roleName, email, id) {
      this.$emit('edit', locked, userName, realName, phoneNum, roleName, email, id)
    },
    deleteUser (userName) {
