...
<template>
  <div class="box">
    ...
    <el-drawer
      ...
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px" style="padding: 0 10px;">
        ...
        <el-form-item label="帐号" prop="roleName">
          <el-input v-model="ruleForm.roleName" placeholder="帐号为必填项" clearable autocomplete="off" @blur="blurCheck(ruleForm.roleName)"></el-input>
        </el-form-item>
    ...
    <el-dialog title="编辑管理员用户" :visible.sync="dialogFormVisible" width="500px" :rules="ruless">
      <el-form :model="formEdit" ref="formEdit" :rules="ruless">
        <el-form-item label="帐号" label-width="80px">
          <el-input v-model="formEdit.userName" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="角色" label-width="80px" prop="">
          <el-input v-model="formEdit.roleName" autocomplete="off" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item label="邮箱" label-width="80px" prop="email">
          <el-input v-model="formEdit.email" autocomplete="off" clearable></el-input>
        </el-form-item>
